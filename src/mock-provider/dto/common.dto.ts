...
export class BalanceQueryDto { @IsString() @IsNotEmpty() memberId!: string; @IsString() @IsNotEmpty() providerCode!: string; }
...
export class LaunchGameDto { @IsString() @IsNotEmpty() memberId!: string; @IsString() @IsNotEmpty() providerCode!: string; @IsString() @IsNotEmpty() gameCode!: string; }
export class MoneyActionDto { @IsString() @IsNotEmpty() memberId!: string; @IsString() @IsNotEmpty() providerCode!: string; @IsOptional() @IsString() gameCode?: string; @Type(() => Number) @IsNumber() @IsPositive() amount!: number; @IsString() @IsNotEmpty() referenceId!: string; }
